...
console.log(umaString.replace(/e/g, '3')); // Troca todos os caractere entre /e/, pelo caracter fora 3 
console.log(umaString.slice(2, 7));
console.log(umaString.slice(-3, -1));
console.log(umaString.split(' ', 2));
console.log(umaString.toUpperCase());// coloca todos os caracteres em letra maiuscula
console.log(umaString.toLowerCase());// coloca todos os caracteres em letra minuscula
